                                ...
                                <thead>
                                    <tr
                                        ...
                                        <th class="min-w-125px sorting"
                                            ...
                                            rowspan="1" colspan="1"
                                            aria-label="Email: activate to sort column ascending"
                                            style="width: 155.266px;">Managers</th>
                                        <!-- <th class="min-w-125px sorting"
                                            tabindex="0"
                                            aria-controls="kt_customers_table"
                                            rowspan="1" colspan="1"
                                            aria-label="Company: activate to sort column ascending"
                                            style="width: 134.188px;">Groupes
                                        </th> -->
                                        <th class="min-w-125px sorting"
                                            tabindex="0"
                                            aria-controls="kt_customers_table"
                                            ...
                                            style="width: 126.516px;">Questions</th>
                                        <th class="min-w-125px sorting"
                                            tabindex="0"
                                            aria-controls="kt_customers_table"
                                            rowspan="1" colspan="1"
                                            aria-label="Created Date: activate to sort column ascending"
                                            style="width: 152.719px;">Questionnaires</th>
                                        <th class="min-w-125px sorting"
                                            tabindex="0"
                                            aria-controls="kt_customers_table"
                                            rowspan="1" colspan="1"
                                            aria-label="Created Date: activate to sort column ascending"
                                            style="width: 152.719px;">Type</th>
                                    </tr>
                                </thead>
                                <tbody class="fw-semibold text-gray-600" id="table">
                                <% allocations.forEach((allocation)=> { %>
                                    <tr class="odd" etat="<%= allocation.active %>">
                                        <td>
                                            <div
                                                class="form-check form-check-sm form-check-custom form-check-solid">
                                                <input class="form-check-input" id="checkbox"
                                                    type="checkbox" onclick="enable()" value="<%= allocation.id %>">
                                            </div>
                                        </td>
                                        <% if(allocation.user) { %>
                                        ...
                                        <td data-filter="email">
                                            <%= allocation.manager.firstName + " " + allocation.manager.lastName %>
                                        </td>
                                        <% } %> 
                                        <% if(!allocation.manager) { %>
                                        <td data-filter="email">
                                        ...
                                        <% } %>  -->
                                        <% if(allocation.question) { %>
                                        <td data-order="subsidiary">
                                            <%= allocation.question.label %>
                                        </td>
                                        <% } %> 
                                        <% if(!allocation.question) { %>
                                        <td data-filter="email">
