                            ...
                            <table aria-describedby=""
                                ...
                                <tbody class="fw-semibold text-gray-600"
                                    ...
                                    <tr class="odd"
                                        ...
                                        <% if (users[i].managerQuiz == false) { %>
                                        <td>
                                            <a href="/evaluation-technicien/<%= users[i].user._id %>/<%= users[i].quiz._id %>" class="btn btn-light btn-active-light-primary btn-sm"
