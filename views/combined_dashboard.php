...
if (!isset($_SESSION["profile"])) {
    ...
    // Liste des pays et agences disponibles pour la sélection
    $agencies = [
        "Burkina Faso" => ["Ouaga"],
    ...
    } elseif ($profile == 'Directeur Filiale' && $userCountry) {
    ...
    if (!$selectedCountry) {
        if ($profile == 'Directeur Filiale' && $userCountry) {
...
?>
    ...
    <div class="content fs-6 d-flex flex-column flex-column-fluid" id="kt_content" data-select2-id="select2-data-kt_content">
        <div class="card-title text-center mb-5">
            ...
            <!--end::Toolbar-->
            <!--begin::Filters pour les graphiques-->
            <div class="row justify-content-center">
                        <?php if ($profile === "Directeur Groupe" || $profile === "Super Admin") { ?>
                            <!-- Sélecteur de pays pour Directeur Groupe ou Super Admin -->
                            <div class="col-md-3 mb-3">
                                <label for="country-select" class="form-label"><?php echo $select_country?>:</label>
                                <select id="country-select" class="form-select" onchange="applyFilters()">
                                    <option value="tous" <?php if ($selectedCountry == 'tous') echo 'selected'; ?>>Tous les pays</option>
                        ...
                        <?php } elseif ($profile === "Directeur Filiale" && $userCountry) { ?>
                            <!-- Sélecteur d'agence pour Directeur Filiale -->
                            <div class="col-md-3 mb-3">
                                <label for="agency-select" class="form-label"><?php echo $select_agency?>:</label>
                                <select id="agency-select" class="form-select" onchange="applyFilters()">
                                    <option value="toutes" <?php if ($selectedAgency == 'toutes' || $selectedAgency == null) echo 'selected'; ?>>Toutes les agences</option>
                    ...
                    <!--end::Filters pour les graphiques-->
                </div>
        ...
        <br><br><br><br><br>
        <!-- Filtre pour le niveau avant le tableau -->
        <div class="row justify-content-center">
            <div class="col-md-3 mb-3">
        ...
        <div class="post fs-6 d-flex flex-column-fluid" id="kt_post">
            ...
            <div class="container-xxl">
                ...
                <div class="d-flex justify-content-end align-items-center" style="margin-top: 20px;">
                    <button type="button" id="excel" class="btn btn-light-primary me-3" data-bs-toggle="modal" data-bs-target="#kt_customers_export_modal">
    ...
    <script>
        function applyFilters() {
            ...
            <?php } elseif ($profile === "Directeur Filiale") { ?>
                if (agency && agency !== "toutes") {
