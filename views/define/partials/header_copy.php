                            ...
                            <div class="hover-scroll-y mx-4" id="kt_aside_menu_wrapper" data-kt-scroll="true"
                                ...
                                <di data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
                                    ...
                                    <?php if ($_SESSION["profile"] == "Super Admin") { ?>
                                        ...
                                        <!--begin:Menu item-->
                                        <div class="menu-item">
                                            <a class="menu-link" href="./trainings"><span
                                                    class="menu-icon">
                                                    <i class="fa fa-line-chart fs-2" ></i>
                                                </span><span class="menu-title"><?php echo $list_training ?></span></a>
                                        </div>
                                        <!--end:Menu item-->
                                        <!--begin:Menu item-->
                                        <div class="menu-item">
                                            <a class="menu-link" href="./createTraining"><span
                                                    class="menu-icon">
                                                    <i class="fa fa-line-chart fs-2" ></i>
                                                </span><span class="menu-title"><?php echo $title_training ?></span></a>
                                        </div>
                                        <!--end:Menu item-->
                                        <!--begin:Menu item-->
                                        <div class="menu-item">
                                            <a class="menu-link" href="./importeTraining"><span
                                                    class="menu-icon">
                                                    <i class="fa fa-line-chart fs-2" ></i>
                                                </span><span class="menu-title"><?php echo $import_training ?></span></a>
                                        </div>
                                        <!--end:Menu item-->
                                    <?php } ?>
                                    <!--begin:Menu item-->
