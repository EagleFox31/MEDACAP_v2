 ...
 */
function filterUsersByProfile($academy, $profile, $country = null, $level = null, $agency = null, $managerId = null,$brand = null) {
...
// -----------------------------------------------------------------
    // ② Ajout du filtre « marque » seulement si $brand est précisé
    // -----------------------------------------------------------------
    if ($brand) {
        $filter['$or'][] = ['brandJunior' => $brand];
        $filter['$or'][] = ['brandSenior' => $brand];
        $filter['$or'][] = ['brandExpert' => $brand];
        $filter['$or'][] = ['brand'       => $brand]; // pour un champ simple
    }

        $results = $academy->users->find($filter)->toArray();
        return $results;
