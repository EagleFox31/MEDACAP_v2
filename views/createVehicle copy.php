...
if (!isset($_SESSION["id"])) {
    ...
    if (isset($_POST["submit"])) {
        ...
        for ($i = 0; $i < count($user); $i++) {
            if (
                $user[$i]->profile == "Technicien" ||
                $user[$i]->profile == "Manager (à évaluer)"
            ) {
        ...
        for ($i = 0; $i < count($user); $i++) {
            if (
                ...
                array_push($userArr, $user[$i]->_id);
                if (
                    $user[$i]->level == "Senior (Réparation)" ||
                    $user[$i]->level == "Expert (Diagnostic)"
                ) {
                    array_push($userArrR, $user[$i]->_id);
                }
        ...
        if (empty($label) || empty($level) || empty($brand)) {
            ...
            if ($level == "Junior") {
                ...
                for ($i = 0; $i < count($userArr); $i++) {
                    $allocateFac = [
                        "vehicle" => new MongoDB\BSON\ObjectId(
                            $resultFac->getInsertedId()
                        ),
            ...
            if (
                ($level == "Junior" && $brand == "MERCEDES TRUCK") ||
                $brand == "RENAULT TRUCK"
            ) {
                $vehicleFac = [
                    "users" => $userArr,
                ...
                ($level == "Senior" && $brand == "MERCEDES TRUCK") ||
                $brand == "RENAULT TRUCK"
            ) {
                $vehicleFac = [
                    "users" => $userArrR,
                ...
                ($level == "Expert" && $brand == "MERCEDES TRUCK") ||
                $brand == "RENAULT TRUCK"
            ) {
                $vehicleFac = [
                    "users" => $userArrD,
