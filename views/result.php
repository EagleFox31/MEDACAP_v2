                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            <?php if($_SESSION['profile'] == "Super Admin") { ?>
                                ...
                                <a class="btn btn-light"
                                    href="./detail.php?numberTest=<?php echo $numberTest; ?>&id=<?php echo $technician->_id; ?>&level=<?php echo $level; ?>"
                                    role="button">
                                ...
                                <a class="btn btn-light" style="margin-left: 10px"
                                    href="./brandResult.php?numberTest=<?php echo $numberTest; ?>&id=<?php echo $technician->_id; ?>&level=<?php echo $level; ?>"
                                    role="button">
                                    <button type="button" class="btn btn-light text-black me-3">
                        ...
                        <div class="table-responsive">
                            <table aria-describedby=""
                                ...
                                <thead>
                                    ...
                                    <th class="min-w-200px sorting  text-black text-center table-light fw-bold text-uppercase gs-0"
                                        tabindex="0" aria-controls="kt_customers_table" 
                                        aria-label="Email: activate to sort column ascending" style="width: 150px;">
                                        <?php echo $qcm_connaissances_tech ?></th>
                                    <th class="min-w-400px sorting text-black text-center table-light fw-bold text-uppercase gs-0"
                                    ...
                                    <tr class="odd" style="">
                                        <td class="min-w-125px sorting text-black text-center table-light text-uppercase gs-0"
                                            ...
                                            <a href="./system.php?numberTest=<?php echo $numberTest; ?>&speciality=<?php echo $transmissionFac->speciality; ?>&level=<?php echo $transmissionFac->level; ?>&user=<?php echo $technician->_id; ?>"
                                                class="btn btn-light btn-active-light-primary fw-bolder btn-sm"
                                ...
                                ?>
                                    ...
                                    <tr class="odd" style="">
                                        ...
                                        <td class="text-center <?php echo getclasses($suspensionPneumatiqueFac); ?>">
                                            <?php $percentSuspensionPneumatiqueFac = round(
                                            ($suspensionPneumatiqueFac->score *
                                                100) /
                                                $suspensionPneumatiqueFac->total); 
                                                
                                                echo $percentSuspensionPneumatiqueFac ?>%
