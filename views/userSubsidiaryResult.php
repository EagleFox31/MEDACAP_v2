                                ...
                                <?php } ?>
                                    ...
                                    <tbody class="fw-semibolder text-gray-600" id="table">
                                        ...
                                        <tr class="odd" style="">
                                            ...
                                            tabindex="0" aria-controls="kt_customers_table" rowspan=`${i}`
                                            aria-label="Email: activate to sort column ascending"
                                            style="width: 155.266px; background-color: #e6f2fb;">
                                            <?php echo $managerTech->level ?>
                                            </td>
                                            <td class="text-center" style="background-color: #e6f2fb; position: sticky; left: 0;">
                                            <?php $brandNiveau = [];
                                            foreach ($managerTech['brand'.$niveau] as $brand) {
                                                array_push($brandNiveau, $brand);
                                            }
                                            if ($niveau != 'Junior') {
                                                $specialityNiveau = [];
                                                foreach ($managerTech['speciality'.$niveau] as $specialite) {
                                                    array_push($specialityNiveau, $specialite);
                                                }
                                            }
                                            if (
                                        ...
                                        <?php if ($niveau != 'Junior') { ?>
                                            <?php if (
                                                in_array('Electricité et Electronique', $specialityNiveau)
                                            ) { ?>
                                            ...
                                            <td class="text-center" style="background-color: #e6f2fb;">
                                            <?php if (
                                                in_array('Hydraulique', $specialityNiveau)
                                            ) { ?>
                                            ...
                                            <td class="text-center" style="background-color: #e6f2fb;">
                                            <?php if (
                                                in_array('Moteur', $specialityNiveau)
                                            ) { ?>
                                            ...
                                            <td class="text-center" style="background-color: #e6f2fb;">
                                            <?php if (
                                                in_array('Transmission', $specialityNiveau)
                                            ) { ?>
                                        ...
                                        <tr class="odd" style="">
                                            ...
                                            if ($niveau != 'Junior') {
                                                $specialityNiveau = [];
                                                foreach ($tech['speciality'.$niveau] as $specialite) {
                                                    array_push($specialityNiveau, $specialite);
                                                }
                                            }
                                            if (
...
function manager() {
    ...
    if (manager.value == "tous") {
        window.location.search = `?level=<?php echo $niveau ?>&subsidiary=<?php echo $subsidiar ?>`;
    }  else {
        window.location.search = `?level=<?php echo $niveau ?>&subsidiary=<?php echo $subsidiar ?>&user=${manager.value}`;
    }
}
