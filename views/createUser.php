...
?>
            ...
            <div class='d-flex flex-column mb-7 fv-row'>
                ...
                <select name='country' aria-label='Select a Country' data-control='select2'
                    data-placeholder='Sélectionnez votre pays...' class='form-select form-select-solid fw-bold'>
            ...
            <div class="fv-row mb-7">
                ...
                <!--end::Label-->
                <!--begin::Input-->
                <input type="text" class="form-control form-control-solid fw-bold" style="background-color: #f8f8f8;"
            ...
            <div class="mb-10 fv-row" data-kt-password-meter="true">
                ...
                <div class="mb-1">
                    ...
                    <div class="position-relative mb-3">
                        <input class="form-control form-control-solid" style="background-color: #f8f8f8;"
