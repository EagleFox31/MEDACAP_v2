...
<body id="kt_body" class="auth-bg">
                        ...
                        <form class="form w-100" action="/forgot-password" method="POST">
                            ...
                            <div class="text-center mb-10">
                                ...
                                <div class="text-gray-400 fw-semibold fs-4">
                                    Entrez votre nom d'utilisateur et un nouveau mot de
                                    passe.
                                </div>
                                <!--end::Link-->
                            </div>
                            ...
                            <div class="fv-row mb-10">
                                <label class="required form-label fw-bolder text-gray-900 fs-6">Nom
                                    d'utilisateur</label>
                            ...
                            <div class="mb-10 fv-row" data-kt-password-meter="true">
                                ...
                                <div class="mb-1">
                                    <!--begin::Label-->
                                    <label class="required form-label fw-bolder ext-gray-900  fs-6">Nouveau mot
                                        de
                                        passe</label>
                                    <!--end::Label-->
                                    <!--begin::Input wrapper-->
                            ...
                            <div class="d-flex flex-wrap justify-content-center pb-lg-0">
                                ...
                                <a href="/" class="btn btn-lg btn-light-primary fw-bold">Annuler</a>
                            </div>
                            <!--end::Actions-->
                        </form>
                        <!--end::Form-->
    ...
    <script src="./public/assets/js/custom/authentication/reset-password/reset-password.js">
    </script>
