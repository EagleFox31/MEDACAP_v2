                                ...
                                <tbody class="fw-semibold text-gray-600" id="table">
                                    <?php
                                        ...
                                        foreach ($allocation as $allocation) {
                                            $quiz = $quizzes->findOne(['_id' => new MongoDB\BSON\ObjectId($allocation->quiz)]);
                                    ?>
                                    <tr class="odd" etat="<?php echo $allocation->active ?>">
                                        <?php if ($allocation->active == true) { ?>
                                        <td class="">
                                            <a href="./userQuiz<?php echo $quiz->type ?>.php?id=<?php echo $quiz->_id ?>"
                                                class="btn btn-light text-primary fw-bolder btn-sm"
                                                data-kt-menu-trigger="click"
                                                data-kt-menu-placement="bottom-end"><?php echo $quiz->label ?>
                                            </a>
                                        </td>
                                        <?php } else {?>
