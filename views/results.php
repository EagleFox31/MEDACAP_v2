                            ...
                            <table aria-describedby=""
                                ...
                                <tbody class="fw-semibold text-gray-600"
                                    ...
                                    <tr class="odd">
                                        ...
                                        <td class="text-end">
                                            <a href="/resultat/<%= users[i].level %>/<%= users[i].user.id %>"
                                                class="btn btn-light btn-active-light-primary btn-sm"
                                                title="Cliquez ici pour voir le résultat du technicien"  
                                                data-kt-menu-trigger="click"
                                                data-kt-menu-placement="bottom-end">Voir resultats
                                            </a>
                                        </td>
                                        <% } %><!--end::Menu-->
                                    </tr>
